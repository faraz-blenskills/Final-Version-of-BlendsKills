...
const services: ImmersiveServiceItem[] = [
  ...
  },
  {
    ...
    desc: "Make your business smarter with custom software, AI-powered automation, intelligent assistants, and workflows built around how your team actually works.",
    provide:
      "We build the software layer behind day-to-day operations: custom business software, CRM and ERP systems, internal portals and dashboards, workflow automation, and AI chatbots, generative AI and computer vision integrations, then connect them into your website, marketing, and support workflows so AI and automation reduce real repetitive work instead of sitting as a standalone gimmick.",
    capabilities: [
    ...
    secondaryCta: { label: "Visit Our Portfolio", to: "/technology-software-portfolio" },
  },
  {
    num: "05",
